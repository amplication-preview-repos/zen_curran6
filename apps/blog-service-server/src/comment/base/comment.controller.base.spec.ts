...
const CREATE_INPUT = {
  ...
  authorField: "exampleAuthorField",
  authorFieldComment: "exampleAuthorFieldComment",
  blogPostRef: "exampleBlogPostRef",
  content: "exampleContent",
  contentField: "exampleContentField",
  contentFieldComment: "exampleContentFieldComment",
  createdAt: new Date(),
  id: "exampleId",
  updatedAt: new Date(),
};
